...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PermissionAdapter.isGranted(this, Manifest.permission.READ_CONTACTS)) {
            getSupportLoaderManager().initLoader(CONTACT_LOAD, null, this);
        } else {
            PermissionAdapter.check(this, Manifest.permission.READ_CONTACTS, CONTACT_REQUEST_CODE);
        }
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        if (id == CONTACT_LOAD) {
            ...
            mCursorLoader = new CursorLoader(MainActivity.this, ContactsContract.Contacts.CONTENT_URI, projectionFields, ContactsContract.Contacts.HAS_PHONE_NUMBER + "=1", null, ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME + "ASC");
            ...
            mCursorLoader = new CursorLoader(MainActivity.this,
                    ContactsContract.CommonDataKinds.Phone.CONTENT_URI, phoneProjectionFields,
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if
            (PermissionAdapter.isGranted(this, Manifest.permission.CALL_PHONE)) {
                Intent dialIntent = new Intent(Intent.ACTION_CALL,
                        Uri.parse("tel:" + contactNumber));
                startActivity(dialIntent);

            } else {
                PermissionAdapter.check(this, Manifest.permission.CALL_PHONE, CALL_REQUEST_CODE);
            }
        }
    }
